    ...
    return (
        ...
        <div className="py-6 mx-auto mb-12 space-y-6 border-b-2 border-gray-200 max-w-7xl lg:mb-16 md:py-12 lg:pb-20 md:flex md:justify-between md:items-center md:flex-row md:space-x-12">
          <div className="flex-1 max-w-3xl">
            <h4 className="text-2xl font-medium text-gray-700 sm:text-3xl md:text-4xl">
              If You Are Convinced, Then Start Organizing Your Sport Clubs Now.
            </h4>
            <p className="mt-4 text-base font-medium leading-relaxed text-gray-500 md:text-xl">
              Organize your sport teams for better management.
            </p>
          </div>
          <a
            href="#_"
            className="inline-block px-5 py-4 font-semibold text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-8"
          >
            Get Started Today
          </a>
        </div>
        <div className="grid max-w-screen-xl gap-6 mx-auto md:grid-cols-2 lg:grid-cols-5 lg:gap-x-8">
          <div className="">
            <h5 className="text-xl font-semibold text-gray-700">Product</h5>
            <nav className="mt-4">
