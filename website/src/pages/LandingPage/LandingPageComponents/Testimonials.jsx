  ...
  <div className="w-full px-20 mx-auto text-left md:px-10 max-w-7xl xl:px-16">
    <div className="box-border flex flex-col flex-wrap justify-center -mx-4">
      <div className="relative w-full mb-12 leading-6 text-left xl:flex-grow-0 xl:flex-shrink-0">
        <h2 className="box-border mx-0 mt-0 font-sans text-4xl font-bold text-center text-indigo-900">
          Testimonials
        </h2>
        <p className="w-full mt-2 text-center text-indigo-800">Don't just take our word for it. See what others have said about us.</p>
      </div>
    </div>
    <div className="box-border flex grid flex-wrap justify-center gap-10 -mx-4 text-center md:grid-cols-2 lg:gap-16 lg:justify-start lg:text-left">
      <div className="flex col-span-1">
        ...
        <div className="relative px-4 mb-16 leading-6 text-left">
          ...
          <div className="box-border mt-5 text-sm font-semibold text-indigo-900 uppercase">
            Alkis Kastrisios
          </div>
          <div className="box-border text-left text-gray-700" /* style={ "auto;"} */>
            DCI gGmbH
          </div>
        </div>
      </div>
      <div className="flex col-span-1">
        ...
        <div className="relative px-4 mb-16 leading-6 text-left">
          ...
          <div className="box-border text-left text-gray-700" style={{"quotes":"auto"}}>
