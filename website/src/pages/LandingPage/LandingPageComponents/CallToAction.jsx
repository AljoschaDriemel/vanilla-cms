...
<section className="w-full px-10 py-12 bg-white lg:py-20">
  <div className="relative flex max-w-5xl px-24 py-16 mx-auto bg-indigo-500 rounded-lg lg:py-20">
    <div className="flex">
    ...
    <img
      ...
      className="absolute bottom-12 right-10 z-20 hidden h-full mr-19 mb-8 origin-right transform scale-50 lg:block lg:mr-19"
