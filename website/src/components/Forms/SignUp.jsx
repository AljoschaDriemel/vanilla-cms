      ...
      <section class="w-full bg-yellow-50">
          ...
          <div class="mx-auto max-w-7xl">
              <div class="flex flex-col  lg:flex-row ">
                  <div class="relative w-full bg-cover lg:w-6/12 xl:w-7/12 bg-yellow-50">
                      <div class="relative flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                          <div class="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                              <div class="relative">
                                  <p class="mb-2 font-medium text-green-500 uppercase">Sport United</p>
                                  <h2 class="text-5xl font-bold text-gray-900 xl:text-6xl">Create your team in a few clicks.</h2>
                              </div>
                              <p class="text-2xl text-gray-700">This account is personal and will enable you to manage your team.</p>
                              <a href="#_" class="inline-block px-8 py-5 text-xl font-medium text-center text-white transition duration-200 bg-green-500 rounded-lg hover:bg-green-600 ease">Get Started Today</a>
                          </div>
                      </div>
                  </div>
