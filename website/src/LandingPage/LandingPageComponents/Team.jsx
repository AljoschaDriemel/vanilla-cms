...
<section className="relative py-20 overflow-hidden bg-gray-800 transform skew-y-0">
  ...
  <div className="relative px-16 mx-auto max-w-7xl ">
    ...
    <h2 className="relative max-w-lg mt-5 mb-10 text-4xl font-semibold leading-tight lg:text-5xl text-green-500">
    ...
    <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4">
      <div className="flex flex-col items-center justify-center col-span-1">
        <div className="relative p-5">
          <div className="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-yellow-50" />
          <img
        ...
        <div className="mt-3 space-y-2 text-center">
          <div className="space-y-1 text-lg font-medium leading-6 text-green-600">
